...
3. 철수는 P를 목표키\(destination key\)로 사용하여 \([디피 헬만 키 교환](https://ko.wikipedia.org/wiki/디피-헬만_키_교환)의 일부로서\) $$R = rG$$를 거래에 포함시킨다. ![](/assets/Screen Shot 2017-08-15 at 2.16.23 AM.png)
4. 
#### 
